# B1 Plugin Build — Research, Scope & Audit → CREATE BUILD SPEC

**Date:** 2026-02-28
**Output:** CREATE `PROJECTS/four-pillars-backtester/BUILD-VINCE-B1-PLUGIN.md` — formal build spec
**Engine confirmed:** v385 (user overrides build plan's v384 reference)
**File handling:** Archive existing `strategies/four_pillars.py` → `strategies/four_pillars_v1_archive.py` first
