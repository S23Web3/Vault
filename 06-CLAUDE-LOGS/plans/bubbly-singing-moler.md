...
| # | Action | File |
|---|--------|------|
| 1 | WRITE (new file) | `scripts/run_55_89_backtest_v2.py` |
...
**File**: `scripts/run_55_89_backtest_v2.py` (NEW — original Backtester384 runner preserved)
...
**Run command**: `python "C:\Users\User\Documents\Obsidian Vault\PROJECTS\four-pillars-backtester\scripts\run_55_89_backtest_v2.py" --symbol BTCUSDT --months 1`
