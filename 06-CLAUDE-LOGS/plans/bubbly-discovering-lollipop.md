...
| File | Action |
|------|--------|
| `C:\Users\User\Documents\Obsidian Vault\PROJECTS\four-pillars-backtester\scripts\dashboard_55_89_v3.py` | MODIFY — add CSS, replace metrics rows, add capital group |
| `C:\Users\User\Documents\Obsidian Vault\PROJECTS\four-pillars-backtester\engine\backtester_55_89.py` | READ ONLY — already has avg_margin_used, peak_margin_used, pct_time_flat |
