...
**Date:** 2026-03-07
**System plan:** C:/Users/User/.claude/plans/transient-brewing-wombat.md
...
4. **No escaped newlines inside string literals** — use `|` separator in title strings
5. **Color assignments for new panels:**
   - Cloud 3 fill: `CLR_EMA` (cyan) at low alpha
   - Cloud 2 lines: `#34d399` (emerald, visible on dark bg)
