...
- Private repo: `S23Web3/obsidian-vault`
...
### A5. Create private GitHub repo and push

```bash
gh repo create S23Web3/obsidian-vault --private --source=. --remote=origin --push
```

**Check:** Go to https://github.com/S23Web3/obsidian-vault — should be there, private, with all your files.
...
```bash
cd /root
git clone git@github.com:S23Web3/obsidian-vault.git vault
```
...
1. `C:\Users\User\Documents\Obsidian Vault\.gitignore` — new file
2. That's it. Everything else is commands you run.
