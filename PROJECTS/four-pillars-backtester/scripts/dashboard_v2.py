...
# ============================================================================
    ...
    if completed_results:
        ...
        selected_coin = st.selectbox("Select coin for detail view", coin_options)
...
# ── PORTFOLIO MODE (v3.1) ─────────────────────────────────────────────────
    ...
    if _pd is not None:
        ...
        pm4.metric("Peak Capital", f"${_peak_cap:,.0f}", help="Max margin across all coins at once")
        ...
        # LSG before/after
        # Extended per-coin metrics table (Phase 2 -- 17 columns)
