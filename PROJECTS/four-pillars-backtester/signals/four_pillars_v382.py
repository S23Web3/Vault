...
from .state_machine_v382 import FourPillarsStateMachine382


def compute_signals_v382(df: pd.DataFrame, params: dict = None) -> pd.DataFrame:
    """
    Run the full Four Pillars v3.8.2 signal pipeline on OHLCV data.
    Uses v3.8.2 state machine (A bypasses Cloud 3).
    """
    if params is None:
        params = {}
